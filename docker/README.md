...
docker-compose -f docker/docker-compose.prosody.yml up -d
...
## 2. docker-compose.prosody.yml - XMPP Server
...
# Check status
docker-compose -f docker/docker-compose.prosody.yml ps
